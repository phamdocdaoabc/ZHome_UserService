...
public class VerificationTokenController {
    ...
    public ResponseEntity<VerificationDTO> findById(@PathVariable("verificationTokenId") @NotBlank(message = "Input must not blank") @Valid Long verificationTokenId) {
    ...
    public ResponseEntity<VerificationDTO> update(@PathVariable("verificationTokenId") @NotBlank(message = "Input must not blank") Long verificationTokenId,
            @RequestBody @NotNull(message = "Input must not NULL") @Valid final VerificationDTO verificationTokenDto) {
    ...
    public ResponseEntity<Boolean> deleteById(@PathVariable("verificationTokenId") @NotBlank(message = "Input must not blank") Long verificationTokenId) {
